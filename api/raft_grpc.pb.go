...
type RaftServiceClient interface {
	...
	BroadcastMsg(ctx context.Context, in *BroadcastMsgRequest, opts ...grpc.CallOption) (*BroadcastMsgResponse, error)
}
...
func (c *raftServiceClient) RequestVote(ctx context.Context, in *VoteRequest, opts ...grpc.CallOption) (*VoteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.RaftService/RequestVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftServiceClient) BroadcastMsg(ctx context.Context, in *BroadcastMsgRequest, opts ...grpc.CallOption) (*BroadcastMsgResponse, error) {
	out := new(BroadcastMsgResponse)
	err := c.cc.Invoke(ctx, "/api.RaftService/BroadcastMsg", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServiceServer interface {
	...
	BroadcastMsg(context.Context, *BroadcastMsgRequest) (*BroadcastMsgResponse, error)
...
func (UnimplementedRaftServiceServer) BroadcastMsg(context.Context, *BroadcastMsgRequest) (*BroadcastMsgResponse, error) {
...
func _RaftService_RequestVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.RaftService/RequestVote",
	}
...
func _RaftService_BroadcastMsg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BroadcastMsgRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServiceServer).BroadcastMsg(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.RaftService/BroadcastMsg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).BroadcastMsg(ctx, req.(*BroadcastMsgRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RaftService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RaftService_BroadcastMsg_Handler,
		},
	},
